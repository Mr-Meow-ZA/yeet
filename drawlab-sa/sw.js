const CACHE='drawlab-v4-shell-1';
const SHELL=['./','./v3/styles-v4.css','./v3/app-v4.js','./v3/icon.svg','./manifest.webmanifest'];
...
self.addEventListener('fetch',event=>{
  ...
  if(url.pathname.includes('/data/')||url.pathname.endsWith('/')){
